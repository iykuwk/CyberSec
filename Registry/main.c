...
BOOL Rc4EncryptionViSystemFunc032(IN PBYTE pRc4Key, IN PBYTE pPayloadData, IN DWORD dwRc4KeySize, IN DWORD sPayloadSize) {
    ...
    //LoadLibraryA calls the advapi.dll | retrieving address of the SystemFunction032 | '(fnSystemFucntion032)' is just a generic pointer
    //It is a huge red flag for payload encryption, SystemFunction032 avoids direct string evidence.
