...
// Defining how the SystemFunction032 function look.(Function point declaration for function) 
...
BOOL Rc4EncryptionViSystemFunc032(IN PBYTE pRc4Key, IN PBYTE pPayloadData, IN DWORD dwRc4KeySize, IN DWORD sPayloadSize) {
	...
	//Basically dynamically loads the function from advapi32.dll .LocalLibraryA("Advapi32")
...
unsigned char shellcode[] = { 
	"Hi hacker here! Spooky things OLALALA!" 
};
...
int main() {
	...
	//Prints encrypted shellcode address
	...
	// Prints DEcrypted shellcode address
